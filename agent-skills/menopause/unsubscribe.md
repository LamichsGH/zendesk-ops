# Menopause GDPR/Unsubscribe Handling

## GDPR/Unsubscribe Rules for Menopause Care

### CRITICAL FORMATTING RULE
Write in NATURAL PROSE - not KB article format.

### KB Search
ALWAYS search the Vector Store first for unsubscribe/marketing communications articles for Menopause Care.
